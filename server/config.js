module.exports = {
    ...
    host: 'star-bg-experiments.onrender.com', // Game server domain. If the host is 'localhost:NUMBER', the NUMBER must be the port setting.
    ...
    */
    ...
    level_cap_cheat: 300, // Maximum level via the level-up key and auto-level-up.
